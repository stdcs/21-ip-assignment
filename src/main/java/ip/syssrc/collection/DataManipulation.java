...
public class DataManipulation {
    ...
    public static void main(String[] args) {
        ...
        // student.add(insert("id, first_name, last_name, gender", "H071171512, Fitrah,
        // Muhammad, Male"));
        // student.add(insert("id, first_name, last_name, gender", "H071171510, Amalia,
        // Dwi, Female"));
        // student.add(insert("id,first_name,last_name,gender", "H071171504,
        // Rabia,Adaw,Female"));
