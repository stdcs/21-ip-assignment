...
public class Cashier {
    ...
    public static void main(String[] args) {
        ...
        if (harga.chars().allMatch(Character::isDigit) && bayar.chars().allMatch(Character::isDigit)) {
            ...
            System.out.println("masukin input yang bener gblk");
        }
        ...
        if (h > 0) {
            System.out.println(h + " lembar buah Rp.500");
        } 
        if (i > 0) {
            System.out.println(i + " lembar buah Rp.200");
        } 
        if (j > 0) {
            System.out.println(j + " lembar buah Rp.100");
        }
        if (kembalian > 0) {
